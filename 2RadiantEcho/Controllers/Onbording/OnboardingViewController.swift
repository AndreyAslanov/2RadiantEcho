...
final class OnboardingViewController: UIViewController {
    ...
    private lazy var first = OnboardingPageViewController(page: .control)
    private lazy var second = OnboardingPageViewController(page: .ideas)
    ...
    override func viewDidLoad() {
        ...
        pagesViewControllers += [first, second]
